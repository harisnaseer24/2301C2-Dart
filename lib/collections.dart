...
// var names={"Haris",435,true,"Shakeel","Farrukh","Umair"};
// names.add("Naeem");
// names.remove(435);
// print(names);
...
// hash table
// naeem => formula=> 1(index) 
// naeem => formula=> 1(index) =>formula =>4(index)
...
// phone['ram']='16gb';
// phone['storage']='256gb';
// phone['sensors']=['proximity', {'accelerometer','90hz freq detector'}, 'gyroscope'];
// phone['touch']='smooth';
// print(phone);
// print(phone['sensors'][1].elementAt(1));
